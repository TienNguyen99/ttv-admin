...
Route::get('/client/kho/phieu-xuat', [InternalMaterialIssueController::class, 'listIndex'])->name('warehouse.issues');
...
Route::get('/client/vat-tu-san-xuat', [InternalProductionMaterialController::class, 'index']);
Route::get('/api/vat-tu-san-xuat', [InternalProductionMaterialController::class, 'data']);
Route::post('/api/vat-tu-san-xuat/tra-lai', [InternalProductionMaterialController::class, 'storeReturn']);
Route::get('/api/vat-tu-san-xuat/phieu-tra', [InternalProductionMaterialController::class, 'returns']);
Route::delete('/api/vat-tu-san-xuat/phieu-tra/{materialReturn}', [InternalProductionMaterialController::class, 'destroyReturn']);
...
Route::post('/api/danh-muc-noi-bo/sua-ma-phieu', [InternalItemCatalogController::class, 'replaceInvalidDocumentCode']);
...
Route::get('/client/nhu-cau-mua-vat-tu', [InternalMaterialDemandController::class, 'page'])->name('warehouse.material-demand');
Route::get('/api/nhu-cau-mua-vat-tu', [InternalMaterialDemandController::class, 'index']);
