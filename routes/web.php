...
Route::get('/api/lenh-det/orders/{order}/plan', [InternalWeavingController::class, 'plan']);
Route::post('/api/lenh-det/orders/{order}/issue', [InternalWeavingController::class, 'createIssue']);
Route::get('/api/lenh-det/production-orders', [InternalWeavingController::class, 'productionOrders']);
